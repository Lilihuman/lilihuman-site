...
function renderContent(content: string) {
  // Split by double newlines or HR markers into blocks
  ...
  return blocks.map((block, i) => {
    ...
    // Italic/em with asterisks — render as italic paragraph (pull quote style)
    ...
    // Regular paragraph — handle inline *italic* and **bold**
    ...
    return (
      <p
        key={i}
        className="font-body text-mocha/80 leading-relaxed mb-5"
