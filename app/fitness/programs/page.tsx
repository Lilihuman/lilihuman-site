...
const programs = [
  {
    ...
    price: '$15.00', badge: null, tags: ['No equipment', 'All levels'],
    image: '/images/programs/20min-hustle-fitness.png',
  },
  {
    id: '20min-hustle-nutrition',
    title: '20-Minute Hustle — Meal Plan Bundle',
    description: 'Two weeks of fat-loss meal plans to pair with your 20-Minute Hustle workouts. Simple, repeatable meals with a grocery list included.',
    price: '$15.00', badge: null, tags: ['All levels'],
  ...
  },
  {
    ...
    price: '$25.00', badge: 'Best value', tags: ['No equipment', 'All levels'],
    image: '/images/programs/20min-hustle-complete.png',
  },
  {
    id: 'postpartum-meal-plan',
    title: 'Postpartum Reset — Meal Plan Bundle',
    description: 'Two weeks of nourishing meal plans for your Postpartum Reset program. Batch-cook friendly, high protein, real-life ready.',
    price: '$15.00', badge: null, tags: ['All levels'],
  ...
  },
  {
    ...
    description: 'Rebuild your core and pelvic floor, restore mobility, and gradually reintroduce strength — all in 20-30 minutes a day.',
    price: '$25.00', badge: null, tags: ['No equipment', 'All levels'],
  ...
  },
  {
    ...
    price: '$35.00', badge: 'Best value', tags: ['No equipment', 'All levels'],
    image: '/images/programs/postpartum-complete.png',
  },
  {
    id: 'strong-mama-nutrition',
    title: 'Strong Mama — 8-Week Nutrition Program',
    description: 'Eight weeks of protein-first meal planning to fuel your workouts and support fat loss — without extreme dieting or cutting food groups.',
    price: '$19.00', badge: null, tags: ['All levels'],
    image: '/images/programs/strong-mama-nutrition.png',
  },
  {
    id: 'strong-mama-8wk',
    title: 'Strong Mama — 8-Week Program',
    description: 'Eight weeks of progressive strength training for busy moms. Four workouts a week, dumbbells and a resistance band, full exercise guide included.',
    price: '$47.00', badge: 'Most popular', tags: ['Dumbbells', 'Intermediate'],
    image: '/images/programs/strong-mama-fitness.png',
  },
  {
    id: 'strong-mama-complete',
    title: 'Strong Mama — Complete Bundle',
    description: 'The full Strong Mama experience — 8 weeks of progressive workouts, the exercise guide, and the complete nutrition program.',
    price: '$57.00', badge: 'Best value', tags: ['Dumbbells', 'All levels'],
