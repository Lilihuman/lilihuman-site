...
const programs = [
  { id: '20min-hustle', title: '20-Minute Hustle — 30-Day Plan', description: 'Thirty days of 20-minute workouts built for real life. No equipment, no gym, no excuses.', price: '$15.00', badge: null, tags: ['No equipment', 'All levels'], image: '/images/programs/20min-hustle-fitness.png' },
  ...
  { id: 'postpartum-reset', title: 'Postpartum Reset — 4-Week Program', description: 'Rebuild your core and pelvic floor, restore mobility, and gradually reintroduce strength — all in 20-30 minutes a day. Four progressive weeks for postpartum moms.', price: '$25.00', badge: null, tags: ['No equipment', 'All levels'], image: '/images/programs/postpartum-fitness.png' },
  { id: 'postpartum-complete', title: 'Postpartum Reset — Complete Bundle', description: 'Everything you need — the full 4-week postpartum fitness program plus both meal plan weeks. Move well, eat well, and rebuild your strength and confidence.', price: '$35.00', badge: 'Best value', tags: ['No equipment', 'All levels'], image: '/images/programs/postpartum-complete.png' },
