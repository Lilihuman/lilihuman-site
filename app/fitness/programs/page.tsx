  ...
  async function handleBuy() {
    ...
    try {
      const res = await fetch('/api/checkout', {
        ...
        body: JSON.stringify({ productId: program.id }),
      });
    ...
    <>
      ...
      <section className="max-w-6xl mx-auto px-5 md:px-8 pb-24">
        ...
        <div className="mt-16 text-center">
          ...
          <p className="font-body text-xs text-mocha/40">All payments are processed securely. Digital downloads delivered instantly after purchase.</p>
        </div>
      </section>
    </>
  );
