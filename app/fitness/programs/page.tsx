...
const programs = [
  { id: '20min-hustle', title: '20-Minute Hustle — 30-Day Plan', description: 'Thirty days of 20-minute workouts built for real life. No equipment, no gym, no excuses.', price: '$15.00 CAD', badge: null, tags: ['No equipment', 'All levels'], image: '/images/programs/20min-hustle-fitness.png' },
  { id: '20min-hustle-nutrition', title: '20-Minute Hustle — Meal Plan Bundle', description: 'Two weeks of fat-loss meal plans to pair with your 20-Minute Hustle workouts. Simple, repeatable meals with a grocery list included.', price: '$15.00 CAD', badge: null, tags: ['All levels'], image: '/images/programs/20min-hustle-nutrition.png' },
  { id: '20min-hustle-complete', title: '20-Minute Hustle — Complete Bundle', description: 'The full package — 30 days of workouts plus two weeks of fat-loss meal plans. Everything you need to move, eat well, and build habits that stick.', price: '$25.00 CAD', badge: 'Best value', tags: ['No equipment', 'All levels'], image: '/images/programs/20min-hustle-complete.png' },
  { id: 'postpartum-meal-plan', title: 'Postpartum Reset — Meal Plan Bundle', description: 'Two weeks of nourishing meal plans for your Postpartum Reset program. Batch-cook friendly, high protein, real-life ready.', price: '$15.00 CAD', badge: null, tags: ['All levels'], image: '/images/programs/postpartum-nutrition.png' },
  { id: 'postpartum-reset', title: 'Postpartum Reset — 4-Week Program', description: 'Rebuild your core and pelvic floor, restore mobility, and gradually reintroduce strength — all in 20-30 minutes a day. Four progressive weeks for postpartum moms.', price: '$25.00 CAD', badge: null, tags: ['No equipment', 'All levels'], image: '/images/programs/postpartum-fitness.png' },
  { id: 'postpartum-complete', title: 'Postpartum Reset — Complete Bundle', description: 'Everything you need — the full 4-week postpartum fitness program plus both meal plan weeks. Move well, eat well, and rebuild your strength and confidence.', price: '$35.00 CAD', badge: 'Best value', tags: ['No equipment', 'All levels'], image: '/images/programs/postpartum-complete.png' },
  { id: 'strong-mama-nutrition', title: 'Strong Mama — 8-Week Nutrition Program', description: 'Eight weeks of protein-first meal planning to fuel your workouts and support fat loss — without extreme dieting or cutting food groups. Simple meals you can actually stick to.', price: '$19.00 CAD', badge: null, tags: ['All levels'], image: '/images/programs/strong-mama-nutrition.png' },
  { id: 'strong-mama-8wk', title: 'Strong Mama — 8-Week Program', description: 'Eight weeks of progressive strength training for busy moms. Four workouts a week, dumbbells and a resistance band, and a full exercise instruction guide included.', price: '$47.00 CAD', badge: 'Most popular', tags: ['Dumbbells', 'Intermediate'], image: '/images/programs/strong-mama-fitness.png' },
  { id: 'strong-mama-complete', title: 'Strong Mama — Complete Bundle', description: 'The full Strong Mama experience — 8 weeks of progressive workouts, the exercise instruction guide, and the complete nutrition program. Everything you need to get stronger.', price: '$57.00 CAD', badge: 'Best value', tags: ['Dumbbells', 'All levels'], image: '/images/programs/strong-mama-complete.png' },
];
